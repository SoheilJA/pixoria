#!/usr/bin/env python
"""
Simple test article creation - No PIL required
Run with: python manage.py shell < create_test_simple.py

This creates a complete test article with all sections filled.
"""
