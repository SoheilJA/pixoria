#!/usr/bin/env python
"""
Script for creating test article data.
Run with: python manage.py shell < create_test_article.py
"""
...
author, created = Author.objects.get_or_create(
    ...
    defaults={
        ...
        "avatar": create_test_image(200, 200, "green", "author_avatar.jpg"),
    },
)
...
article, created = Article.objects.get_or_create(
    ...
    defaults={
        ...
        "category": category,
        "author": author,
        "cover_image": create_test_image(1600, 900, "purple", "cover.jpg"),
...
print(f"Article: {article.title} ({'Created' if created else 'Exists'})")

# 5. Add Tags to Article
article.tags.set(tags)
print(f"Tags added to article")

print("\n✅ Test data created successfully!")
print(f"Article URL: /blog/{article.slug}/")
